(custom-set-variables
 ...
 '(package-selected-packages '(arduino-mode))
 '(pdf-info-epdfinfo-program "/usr/bin/epdfinfo")
 '(pona:portage-dir
   (if (file-exists-p "/var/db/repos/gentoo") "/var/db/repos/gentoo"
     "/usr/portage"))
 '(send-mail-function 'mailclient-send-it)
 '(smtpmail-smtp-server "imap.gmail.com")
 '(smtpmail-smtp-service 25)
 '(warning-suppress-types
   '((gentoo-cache) (gentoo-cache) (gentoo-cache) (emacs) (emacs) (defvaralias))))
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(vterm-color-blue ((t (:inherit 3399FF)))))
