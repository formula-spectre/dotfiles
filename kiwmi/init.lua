...
local keybinds = {
  ...
  { true,       false,    false,      false,        'Return',   function() kiwmi:spawn("foot") end },
  { true,       false,    false,      false,        'p',        function() kiwmi:spawn("bemenu-run") end },
  { true,       false,    false,      true,         'q',        function() kiwmi:quit() end },
  { true,       false,    false,      true,         'c',        function() local v = kiwmi:focused_view() if v then v:close() end end },
